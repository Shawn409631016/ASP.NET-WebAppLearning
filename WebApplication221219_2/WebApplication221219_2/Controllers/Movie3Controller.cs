...
using WebApplication221219_2.Data;
using WebApplication221219_2.Models;

namespace WebApplication221219_2.Controllers
{
    public class Movie3Controller : Controller
    {
        private readonly MovieContext _context;

        public Movie3Controller(MovieContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var movie3 = await _context.Movie
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var movie3 = await _context.Movie.FindAsync(id);
            if (movie3 == null)
            {
                return NotFound();
            }
